...
## Project Structure
    ...
    ├── testapiautoconnect_117782  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_117782`
...
2. Clone this repo and `cd testapiautoconnect_117782`
